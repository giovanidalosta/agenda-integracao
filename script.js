...
(function () {
  ...
  function renderAgenda() {
    ...
    agendaDoc.innerHTML =
      `<div class="doc-stripe"></div><div class="doc-header"><div class="doc-logo"><img src="logo-agenda.png" alt="Ikatec" onerror="this.style.display='none';this.parentElement.innerHTML='<span class=doc-logo-placeholder>IK</span>'" /></div><div class="doc-title-area"><div class="doc-label">Ikatec Tecnologia e Inovacao</div><div class="doc-title">Agenda de Integração</div><div class="doc-welcome">Bem-vindo(a) a Ikatec, ${escHtml(name)}!</div></div></div><div class="doc-info-band"><div class="doc-info-item"><div class="doc-info-label">Colaborador</div><div class="doc-info-value">${escHtml(name)}</div></div><div class="doc-info-item"><div class="doc-info-label">Data da Integração</div><div class="doc-info-value">${dateStr}</div></div></div><div class="doc-body"><div class="doc-section-label">Programação do Dia</div>${tableHtml}</div><div class="doc-footer"><span class="doc-footer-tag">Tecnologia e inovação para transformar negócios e pessoas</span><span class="doc-footer-logo"><img src="logo-agenda.png" alt="Logo Ikatec" class="footer-logo" onerror="this.style.display='none'"></span></div>`;
  }
  /* Export PDF */
